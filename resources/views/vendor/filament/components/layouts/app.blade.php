...
{{--          <div class="bg-grad h-screen">--}}
            <header class="h-[3.5rem] shrink-0 w-full text-white flex items-end">
                <div @class([
                    ...
                    <div class="flex-1 flex items-center justify-between">
                        ...
                        <div class="text-2xl text-white font-light">Major Construction Frameworks</div>
...
{{--                        @livewire('filament.core.global-search')--}}
            ...
            <div @class([
                'flex-1 w-full rounded-sm px-4 mx-auto md:px-6 lg:px-8 bg-white/80 md:pb-6 lg:pb-8',
                match (config('filament.layout.max_content_width')) {
                    'xl' => 'max-w-xl',
                    '2xl' => 'max-w-2xl',
                    '3xl' => 'max-w-3xl',
