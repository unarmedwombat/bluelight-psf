        ...
        <div class="pt-2">
            <button
                ...
                {{ $attributes->merge($getExtraAttributes())->class([
                    'relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:border-primary-300 focus:ring-2 focus:ring-primary-200 bg-gray-200',
